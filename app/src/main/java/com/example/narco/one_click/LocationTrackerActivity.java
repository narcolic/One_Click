...
public class LocationTrackerActivity extends LocationBaseActivity {
    ...
    public void onLocationChanged(Location location) {
        ...
        if (user != null) {
            databaseReference.child(user.getUid()).child("location").setValue(longlat);
        }
        finish();
    }
